...
<section class="contact_area p_120">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Hospital Register') }}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action='{{ url("register/hospital") }}' aria-label="{{ __('Register') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <label for="credentials" class="col-md-4 col-form-label text-md-right">Hospital Credentials</label>

                                <div class="col-md-6">
                                    <input id="credentials" type="file" class="form-control @error('credentials') is-invalid @enderror" name="credentials" required>
