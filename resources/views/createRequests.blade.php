                    ...
                    <div class="col-lg-8 col-md-8 ">
                        <div class="mt-10">
                            <div class="form-group">
                                <input type="number" class="form-input" name="amount" placeholder="Amount" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Amount'" required class="single-input" min="1">
                            </div>
                        </div>
                        <div class="mt-10">
                            <div class="form-group ">
